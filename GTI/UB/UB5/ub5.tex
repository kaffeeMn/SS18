...
Ich nehme an, dass ich f"ur $N_L$ keinen Induktionsbeweis f"uhren muss, da
    die Wortl"ange aller W"orter aus der Sprache der Grammatik mit der Einzigen 
    Regel $S \rA abb | aSbb$ gleich 3 beim kleinsten, 3+3 beim n"achst kleinsten
    Element ist und S induktiv definiert ist.\\
