...
Die Markierten Bereiche entsprechen den jeweiligen Teilw"ortern und entsprechen
    dem Baukastenprinzip aus der Vorlesung, damit ist der Automat entsprechend
    dem Baukastenprinzip der Vorlesung aufgebaut.\\
\subsubsection\
...
Sind korrekt, da:\\
\gap
Ferner gilt $L = (W_0 - W_1) - W_2$\\
Offensichtlich gilt $(W_0 - W_1) = W_0$. $W_0 - W_2$ ergibt sich zu:\\
\[
